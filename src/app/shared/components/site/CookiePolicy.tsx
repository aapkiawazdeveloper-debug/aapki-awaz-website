    ...
    <>
      <section className="flex flex-col gap-y-4">
        <p className="text-black text-base font-normal font-poppins text-justify">
          ...
          technologies we use. This Cookie Policy explains how and why cookies
          and other similar technologies may be stored on and accessed from your
          device when you use or visit "Aap Ki Awaz" website or application that
          posts a link to this Policy (collectively, “the Sites”). This Cookie
        ...
        <div className="flex flex-col gap-y-1">
          ...
          <p className="text-black text-base font-normal font-poppins text-justify">
            ...
            Sites. This allows our Sites to recognize your device from those of
            other users of the Sites. The information provided below about
        ...
        <div className="flex flex-col gap-y-1">
          ...
          <p className="text-black text-base font-normal font-poppins text-justify">
            ...
            tracking technologies to control access to certain content on our
          ...
          <p className="text-black text-base font-normal font-poppins text-justify">
            ...
            our site users. These third-party service providers use persistent
            cookies to help us to improve the user experience, manage our site
            content, and analyse how users navigate and utilize the sites.
          </p>
        </div>
        <div className="flex flex-col gap-y-1">
          <h2 className="text-black text-xl font-medium font-poppins">
          ...
          <p className="text-black text-base font-normal font-poppins text-justify">
            ...
            and serve you with advertisements).
          </p>
        </div>
        <div className="flex flex-col gap-y-1">
          <h2 className="text-black text-xl font-medium font-poppins">
          ...
          <p className="text-black text-base font-normal font-poppins text-justify">
            ...
            information will be kept in our database until we get explicit
            consent from you to remove all the stored cookies.
          </p>
        </div>
        <div className="flex flex-col gap-y-2">
          ...
          <div className="flex flex-col gap-y-0.5">
            ...
            <p className="text-black text-base font-normal font-poppins text-justify">
              ...
              have logged in/out to access Site content. They also include
              Cookies that enable us to remember your previous actions within
          ...
          <div className="flex flex-col gap-y-0.5">
            ...
            <p className="text-black text-base font-normal font-poppins text-justify">
              ...
              visited, watch history and from what locations our visitors come
              from. If you subscribe to a newsletter or otherwise register with
              the Sites, these Cookies may be correlated to you. These Cookies
              include, for example, Google Analytics cookies.
            </p>
          </div>
          <div className="flex flex-col gap-y-0.5">
            <h2 className="text-black text-lg font-medium font-poppins">
            ...
            <p className="text-black text-base font-normal font-poppins text-justify">
              ...
              and remember how you customized the Sites and services, for
              example by adjusting text size, fonts, languages and other parts
              of web pages that are alterable, and provide you with the same
              customizations during future visits.
            </p>
          </div>
          <div className="flex flex-col gap-y-0.5">
            <h2 className="text-black text-lg font-medium font-poppins">
            ...
            <p className="text-black text-base font-normal font-poppins text-justify">
              ...
              as well as help measure the effectiveness of the advertising
              campaigns on Dainik Bhasker Group and other websites. They
              remember that you have visited one of our websites and this
              information is shared with other parties, including advertisers
            ...
            <p className="text-black text-base font-normal font-poppins text-justify">
              ...
              domains, for example Facebook and Google DoubleClick. We endeavour
              to identify these cookies before they are used so that you can
              decide whether you wish to accept them or not. We also use a
              number of partners to provide digital experiences and
              functionalities on our websites. For example, while browsing our
              websites you may be served cookies from third-parties who provide
              some of its features on Aap Ki Awaz Publication websites (e.g., a
              YouTube video), although you have withdrawn or declined your
              consent to our cookies. This happens because you have directly
              given your consent to the use of their cookies. In such cases, you
            ...
            <p className="text-black text-base font-normal font-poppins text-justify">
              ...
              be able to directly identify you as an individual or have any of
              your personal information such as Name, E-mail id or mobile
              number.
            </p>
          </div>
          <div className="flex flex-col gap-y-0.5">
          ...
          <div className="flex flex-col gap-y-0.5">
            ...
            <p className="text-black text-base font-normal font-poppins text-justify">
              ...
              refer to your browser ‘help’ / ‘tool’ or ‘edit’ section for cookie
            ...
            <p className="text-black text-base font-normal font-poppins text-justify">
              ...
              www.aboutads.info/choices if in the United States.
            </p>
          </div>
